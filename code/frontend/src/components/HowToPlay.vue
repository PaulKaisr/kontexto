      ...
      <div class="space-y-3 sm:space-y-4">
          ...
          <v-list class="pa-0" density="compact">
            <v-list-item class="px-0 py-1 min-height-auto">
              ...
              <v-list-item-title class="text-body-2 text-wrap"
                >Gib ein deutsches Wort ein und drücke Enter</v-list-item-title
              >
            </v-list-item>
            <v-list-item class="px-0 py-1 min-height-auto">
              <template v-slot:prepend>
              ...
              <v-list-item-title class="text-body-2 text-wrap"
                >Das Wort wird nach semantischer Ähnlichkeit
                bewertet</v-list-item-title
              >
            </v-list-item>
            <v-list-item class="px-0 py-1 min-height-auto">
              <template v-slot:prepend>
              ...
              <v-list-item-title class="text-body-2 text-wrap"
                >Je höher die Ähnlichkeit, desto näher die
                Lösung</v-list-item-title
              >
            </v-list-item>
            <v-list-item class="px-0 py-1 min-height-auto">
              <template v-slot:prepend>
              ...
              <v-list-item-title class="text-body-2 text-wrap"
                >Die Farbe zeigt dir an, wie nah du bist</v-list-item-title
              >
            </v-list-item>
          </v-list>
        </v-card>
        ...
        <v-card variant="outlined" class="pa-2 sm:pa-3">
          ...
          <div class="d-flex flex-column ga-1">
            ...
            >
              <v-icon icon="mdi-circle" class="mr-1" size="x-small"></v-icon>
            ...
            <v-chip
              ...
              style="width: 100%; height: auto; white-space: normal"
            >
              <v-icon icon="mdi-star" class="mr-1" size="x-small"></v-icon>
        ...
        <v-card variant="outlined" class="pa-2 sm:pa-3">
          ...
          <p class="text-body-2 mb-0">
            Du kannst jederzeit einen Hinweis erhalten, der dir ein Wort mit
            hoher Ähnlichkeit zum Lösungswort zeigt.
          </p>
        </v-card>
        ...
        <v-card variant="outlined" class="pa-2 sm:pa-3">
          ...
          <v-list class="pa-0" density="compact">
            <v-list-item class="px-0 py-1 min-height-auto">
              ...
              <v-list-item-title class="text-body-2 text-wrap"
                >Denke an Synonyme und verwandte Begriffe</v-list-item-title
              >
            </v-list-item>
            <v-list-item class="px-0 py-1 min-height-auto">
              <template v-slot:prepend>
              ...
              <v-list-item-title class="text-body-2 text-wrap"
                >Probiere verschiedene Wortarten aus</v-list-item-title
              >
            </v-list-item>
            <v-list-item class="px-0 py-1 min-height-auto">
              <template v-slot:prepend>
              ...
              <v-list-item-title class="text-body-2 text-wrap"
                >Nutze die Statistikleiste für den
                Fortschritt</v-list-item-title
              >
            </v-list-item>
            <v-list-item class="px-0 py-1 min-height-auto">
              <template v-slot:prepend>
              ...
              <v-list-item-title class="text-body-2 text-wrap"
                >Jedes Wort kann nur einmal geraten werden</v-list-item-title
              >
            </v-list-item>
          </v-list>
        </v-card>
        ...
        <v-alert type="info" variant="tonal" class="text-body-2">
          ...
          <div>
            ...
            FastText-Worteinbettungen berechnet, die semantische Beziehungen
            zwischen Wörtern erfassen.
          </div>
        </v-alert>
      </div>
    </v-card-text>
