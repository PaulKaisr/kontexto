    ...
    <v-card-text class="pa-2 sm:pa-4 flex-grow-1" style="overflow-y: auto">
      <div class="space-y-3 sm:space-y-4">
        ...
        <v-card variant="outlined" class="pa-2 sm:pa-3">
          ...
          <p class="text-body-2 mb-3">Wähle dein bevorzugtes Farbschema für die App.</p>
          <v-radio-group
        ...
        <v-card variant="outlined" class="pa-2 sm:pa-3">
          <div class="d-flex align-center mb-2">
            ...
            <h3 class="text-subtitle-1 font-bold text-primary">Cookie-Einstellungen</h3>
          </div>
          <p class="text-body-2 mb-3">Verwalte deine Cookie-Präferenzen für diese Website.</p>

          <!-- Necessary Cookies -->
          <div class="mb-4">
            <div class="d-flex align-center justify-space-between mb-2">
              <div class="d-flex align-center">
                <v-icon color="success" class="me-2" size="small"> mdi-shield-check </v-icon>
          ...
          <div class="mb-4">
            <div class="d-flex align-center justify-space-between mb-2">
              <div class="d-flex align-center">
                <v-icon color="info" class="me-2" size="small"> mdi-chart-line </v-icon>
          ...
          <div class="mb-2">
            <div class="d-flex align-center justify-space-between mb-2">
              <div class="d-flex align-center">
                <v-icon color="warning" class="me-2" size="small"> mdi-bullhorn </v-icon>
        ...
        <v-alert type="info" variant="tonal" class="text-body-2">
          ...
          <div>
            <strong>Hinweis:</strong> Deine Einstellungen werden automatisch gespeichert und beim
            nächsten Besuch wiederhergestellt.
          </div>
        </v-alert>
      </div>
    </v-card-text>
