<template>
  <v-container class="dialog">
    <v-card>
      ...
      <v-card-text>
        <p id="m4158" class="text-h5 my-2">Präambel</p>
        <p>
        ...
        <div id="m3" class="text-h5 my-2">Verantwortlicher</div>
        <p>Paul Kaiser<br />Leonhardtstraße 2<br />76131 Karlsruhe</p>
        E-Mail-Adresse:
        <p>
          <a class="underline text-blue-300" href="mailto:kontexto.app@gmail.com"
        ...
        <div id="mOverview" class="text-h5 my-2">Übersicht der Verarbeitungen</div>
        <p>
        ...
        <div id="m13" class="text-h5 my-2">Maßgebliche Rechtsgrundlagen</div>
        <p>
        ...
        <div id="m27" class="text-h5 my-2">Sicherheitsmaßnahmen</div>
        <p>
        ...
        <div id="m25" class="text-h5 my-2">Übermittlung von personenbezogenen Daten</div>
        <p>
        ...
        <div id="m24" class="text-h5 my-2">Datenverarbeitung in Drittländern</div>
        <p>
        ...
        <div id="m12" class="text-h5 my-2">Löschung von Daten</div>
        <p>
          ...
          oder sie für den Zweck nicht erforderlich sind). Sofern die Daten nicht gelöscht werden,
          weil sie für andere und gesetzlich zulässige Zwecke erforderlich sind, wird deren
          Verarbeitung auf diese Zwecke beschränkt. D.h., die Daten werden gesperrt und nicht für
        ...
        <div id="m134" class="text-h5 my-2">Einsatz von Cookies</div>
        <p>
        ...
        <p>
          ...
          stellen. Die widerrufliche Einwilligung wird gegenüber den Nutzern deutlich kommuniziert
        ...
        <p>
          ...
          Falls die Nutzer einwilligen, ist die Rechtsgrundlage der Verarbeitung Ihrer Daten die
          erklärte Einwilligung. Andernfalls werden die mithilfe von Cookies verarbeiteten Daten auf
          Grundlage unserer berechtigten Interessen (z.B. an einem betriebswirtschaftlichen Betrieb
          unseres Onlineangebotes und Verbesserung seiner Nutzbarkeit) verarbeitet oder, wenn dies
          im Rahmen der Erfüllung unserer vertraglichen Pflichten erfolgt, wenn der Einsatz von
          Cookies erforderlich ist, um unsere vertraglichen Verpflichtungen zu erfüllen. Zu welchen
        ...
        <v-list>
          ...
          <li>
            <strong>Permanente Cookies:</strong> Permanente Cookies bleiben auch nach dem Schließen
        ...
        <p>
          ...
          Nutzer können ihren Widerspruch auch über die Einstellungen ihres Browsers erklären, z.B.
          durch Deaktivierung der Verwendung von Cookies (wobei dadurch auch die Funktionalität
          unserer Online-Dienste eingeschränkt sein kann). Ein Widerspruch gegen die Verwendung von
        ...
        <v-list class="m-elements">
          <li>
            <strong>Cookie-Einstellungen und Verwaltung: </strong>Wir verwenden ein
            Cookie-Consent-System, das Ihnen die volle Kontrolle über Ihre Cookie-Präferenzen gibt.
            Bei Ihrem ersten Besuch unserer Website erscheint ein Cookie-Banner, über den Sie Ihre
            Einstellungen verwalten können. Sie können jederzeit über die Cookie-Einstellungen am
            unteren rechten Bildschirmrand Ihre Präferenzen ändern. <br /><br />
            <strong>Cookie-Kategorien:</strong>
            <ul class="mt-2">
              <li>
                <strong>Notwendige Cookies:</strong> Diese sind für das Funktionieren der Website
                erforderlich und können nicht deaktiviert werden. Sie speichern Ihre Spielstände und
                Einstellungen.
              </li>
              <li>
                <strong>Analyse-Cookies:</strong> Diese helfen uns zu verstehen, wie Besucher unsere
                Website nutzen (Google Analytics). Sie können diese deaktivieren.
              </li>
              <li>
                <strong>Marketing-Cookies:</strong> Diese werden für personalisierte Werbung
                verwendet, einschließlich Google AdSense. Sie können diese jederzeit deaktivieren.
              </li>
            </ul>
        ...
        <div id="m225" class="text-h5 my-2">Bereitstellung des Onlineangebotes und Webhosting</div>
        <p>
        ...
        <v-list class="m-elements">
          <li>
            ...
            Serverlogfiles können zum einen zu Zwecken der Sicherheit eingesetzt werden, z.B., um
            ...
            ihre Stabilität sicherzustellen; <strong>Rechtsgrundlagen:</strong> Berechtigte
          ...
          <li>
            ...
            Content Delivery Network und Deployment-Services);
            <strong>Dienstanbieter:</strong> Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789,
            USA; <strong>Rechtsgrundlagen:</strong> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit.
            f) DSGVO);
        ...
        <div id="m263" class="text-h5 my-2">Webanalyse, Monitoring und Optimierung</div>
        <p>
          ...
          Informationen zu den Besuchern, wie z.B. das Alter oder das Geschlecht, als pseudonyme
          Werte umfassen. Mit Hilfe der Reichweitenanalyse können wir z.B. erkennen, zu welcher Zeit
          unser Onlineangebot oder dessen Funktionen oder Inhalte am häufigsten genutzt werden oder
          zur Wiederverwendung einladen. Ebenso können wir nachvollziehen, welche Bereiche der
        ...
        <v-list class="m-elements">
          <li>
            <strong>Google Analytics: </strong>Webanalyse, Reichweitenmessung sowie Messung von
            Nutzerströmen; <strong>Dienstanbieter:</strong> Google Ireland Limited, Gordon House,
            Barrow Street, Dublin 4, Irland; <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6
        ...
        <div id="m264" class="text-h5 my-2">Werbung und Marketing</div>
        <p>
          Wir verwenden Werbedienstleister, um die kostenlose Bereitstellung unseres Onlineangebotes
          zu finanzieren. Diese Dienste verwenden Cookies und andere Technologien, um
          personalisierte Werbung zu schalten und die Werbeleistung zu messen.
        </p>
        <v-list class="m-elements">
          <li>
            <strong>Verarbeitete Datenarten:</strong> Nutzungsdaten (z.B. besuchte Webseiten,
          ...
          <li>
            <strong>Zwecke der Verarbeitung:</strong> Bereitstellung unseres Onlineangebotes und
            Nutzerfreundlichkeit; Marketing; Profile mit nutzerbezogenen Informationen; Tracking.
          </li>
          <li>
            <strong>Rechtsgrundlagen:</strong> Einwilligung (Art. 6 Abs. 1 S. 1 lit. a) DSGVO);
        ...
        <v-list class="m-elements">
          <li>
            <strong>Google AdSense: </strong>Wir nutzen Google AdSense zur Schaltung von
            Werbeanzeigen. Google AdSense verwendet Cookies, um anzeigenrelevante Informationen zu
            sammeln und personalisierte Werbung zu schalten. <strong>Dienstanbieter:</strong> Google
        ...
        <div id="m10" class="text-h5 my-2">Rechte der betroffenen Personen</div>
        <p>
